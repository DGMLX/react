...
export const HomePage = () =>{
    ...
    return(
        <>
            ...
            <section className="section1 container-fluid">
                ...
                <div className="row texto-section1 mt-5 a ">
                        ...
                        <div className="w-100 d-flex justify-content-center mt-3">
                            <Link className="btn-section1 enlace " to="/proyectos" onClick={goingUp} id="intersection1">Ver proyectos</Link>
                        </div>
                </div>
            ...
            <section className="section-price container mt-5 d-md-none" id="intersection2">
            ...
            <section className="section2 mt-5 container">
                ...
                <div className="d-flex justify-content-around align-items-center" >
                    <div className="col-12 col-md-7">
                        ...
                        <div className="w-100 d-flex justify-content-center mt-5" id="intersection12">
                        <Link className="text-center btn-section2 enlace" to="/contacto" onClick={goingUp}>Contáctanos</Link>
                        </div>
                    </div>

                    <div className="section-price container col-4 d-none d-md-block">
                        <div className="text-center m-auto contenedor-price " id="intersection3">
                            <h2 className="mt-3 mb-3">Desarrollo de sitio web</h2>
                            <h3 className="mt-3 mb-3 price">$80.000</h3>
                            <ul className="contenedor-lista">
                                <li><i className="bi bi-caret-right-fill"></i>Dominio .cl gratis 1 año</li>
            ...
            <section className="section3 mt-5">
                    <div className=" d-flex justify-content-center flex-wrap">
                        <img src="/img/imgpng1.png" className="imgpng col-12 " alt="" id="intersection4"/>
                    ...
                    <div className="d-flex justify-content-center flex-wrap mt-3">
                        <img src="/img/imgpng2.png" className="imgpng col-12 " alt="" id="intersection5"/>
                    ...
                    <div className=" d-flex justify-content-center flex-wrap">
                        <img src="/img/imgpng3.png" className="imgpng col-12" alt="" id="intersection6"/>
                    ...
                    <div className="w-100 d-flex justify-content-center mt-4">
                        <Link className="text-center btn-section2 enlace" id="intersection7" to="/servicios" onClick={goingUp}>Conoce nuestros servicios</Link>
                        </div>
                ...
                <div>
                    <div className="col-12 mb-5">
                        <a href="https://arriendodecamionesplumagyg.cl/" target="_blank" className="enlace-proyectos">
                            <div className="proyecto-izajes d-flex justify-content-center align-items-center" id="intersection8">
                    ...
                    <div className="col-12 mt-5 mb-5">
                        <a href="https://aridosquintaregion.cl/" target="_blank" className="enlace-proyectos">
                            <div className="proyecto-aridos d-flex justify-content-center align-items-center " id="intersection9">
                                <h2 className="visitar-web w-100 text-center pt-2 pb-2">VER SITIO WEB</h2>
                            </div>
                        </a>
                    ...
                    <div className="col-12 mt-5 mb-5">
                        <a href="https://dgmlx.github.io/soporteComputacional/" target="_blank" className="enlace-proyectos">
                            <div className="proyecto-soporte d-flex justify-content-center align-items-center" id="intersection10">
                                <h2 className="visitar-web w-100 text-center pt-2 pb-2">VER SITIO WEB</h2>
                            </div>
                        </a>
                    ...
                    <div className="w-100 d-flex justify-content-center mt-4 " id="intersection11">
                        <Link className="text-center btn-section2 enlace" to="/proyectos" onClick={goingUp}>Ver más proyectos</Link>
                    </div>
